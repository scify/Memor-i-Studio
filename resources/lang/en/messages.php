...
return [
    ...
    */
    ...
    'term-of-use-11' => 'Except for the conditions of the previous paragraph regarding personal data, <a href="https://www.scify.org/" target="_blank">  SciFY </a> maintains the right to change the Terms and Conditions, if they need to be updated or completed, at any time and without notice, therefore the user must be informed of any changes before each use of the application.',
    'term-of-use-10' => '<a href="https://www.scify.org/" target="_blank">  SciFY </a> uses the personal data that each user enters only in the context of the <a href="https://memoristudio.scify.org/" target="_blank"> Memor-i Studio </a> project, for statistical purposes and for coming in touch with them, if need be. Personal data is not made public to third parties without the user’s permission.',
    ...
    'term-of-use-8' => 'Each content creator does not compete with other content creators, they recognize their contribution and co-operate with them to improve and enrich the content of <a href="https://memoristudio.scify.org/" target="_blank"> Memor-i Studio </a>.',
    'term-of-use-7' => '<a href="https://www.scify.org/" target="_blank">  SciFY </a> cannot guarantee the appropriateness of the content of other game creators of <a href="https://memoristudio.scify.org/" target="_blank"> Memor-i Studio </a>. However, it maintains the right to request that the creator makes corrections to or deletes the content, if something unacceptable comes to its attention. The users are encouraged to notify <a href="https://www.scify.org/" target="_blank">  SciFY </a> about non-acceptable content.',
    ...
    'term-of-use-4' => '<a href="https://www.scify.org/" target="_blank">  SciFY </a> is not responsible for the quality/appropriateness of the content or the content uploaded to the application, its correctness or its quality, but only for the content uploaded by <a href="https://www.scify.org/" target="_blank">  SciFY </a> itself as a creator.',
    'term-of-use-3' => 'The <a href="https://memoristudio.scify.org/" target="_blank"> Memor-i Studio </a> application is addressed to services and scientists that deal with the care and rehabilitation of people that belong to the groups mentioned above, as well as people providing relevant care at home.',
    'term-of-use-2' => 'The content of <a href="https://memoristudio.scify.org/" target="_blank"> Memor-i Studio </a> is mainly addressed to the caregivers of people/patients with blindness.',
