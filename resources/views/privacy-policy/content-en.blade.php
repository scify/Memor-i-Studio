        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="margin-top-20 margin-bottom-20">1. Who is the Data Controller?</h2>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="margin-top-20 margin-bottom-20">3. Types of data collected</h2>

                            <h3 class="margin-top-20 margin-bottom-20">3.1 Personal data</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="margin-top-20 margin-bottom-20">7.How is data security safeguarded?</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="margin-top-20 margin-bottom-20">8. Who are the recipients of data?</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="margin-top-20 margin-bottom-20">9. Communication with the Data Controller</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="margin-top-20 margin-bottom-20">13. Amendments to this Privacy Policy </h2>
